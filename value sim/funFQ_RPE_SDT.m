function varargout=funFQ_RPE_SDT(xpar,dat,init_v)
% % funFQ_RPE_CK %
...
Q = init_v; % 2x2 matrix for Q(A,L), Q(A,R), Q(B,L), Q(B,R)
...
for k=1:nt
    ...
    pleft  = p_A*(1/(1+exp(-beta*deltaQA))) + p_B*(1/(1+exp(-beta*deltaQB)));
    pright = 1-pleft;
