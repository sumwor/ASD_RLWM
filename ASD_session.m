...
if ~exist(savebehfigpath)
 ...
 %% analysis of behavioral performance
    ...
    edges=[-0.5:0.05:10];
    responseTime = plot_responseTimes(resultdf, edges, tlabel, savebehfigpath);
