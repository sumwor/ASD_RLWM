function mixed_logreg_RCUC(dataIndex,tlabel, nSession, step_back, savefigpath)
...
for s = 1:nSessions
    csvfilepath = fullfile(dataIndex.BehPath{s}, dataIndex.BehCSV{s});
